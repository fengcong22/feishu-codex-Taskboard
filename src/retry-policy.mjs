...
const SAFE_DELIVERY_ERROR_CODES = new Map([
  ...
  "DELIVERY_FAILED",
  "DECISION_SNAPSHOT_CONFLICT",
  "DECISION_SNAPSHOT_INVALID",
  "DECISION_SNAPSHOT_MISSING",
  "DECISION_SNAPSHOT_PACKAGE_UNAVAILABLE",
  ...
  "FEISHU_METADATA_CLIENT_INVALID",
  "FEISHU_METADATA_INVALID_RESPONSE",
  "FEISHU_METADATA_READ_FAILED",
  "FEISHU_TABLE_NOT_FOUND",
  "FEISHU_TASK_DELETED",
  "FEISHU_WIKI_NOT_BASE",
  "FEISHU_METADATA_UNAVAILABLE",
  "FEISHU_WORKFLOW_CONFIG_UNAVAILABLE",
  "FEISHU_RECORD_LOOKUP_FAILED",
  "FEISHU_WRITEBACK_FAILED",
  "FEISHU_SDK_MISSING",
  "FEISHU_SUBSCRIPTION_INVALID_RESPONSE",
  "FEISHU_SUBSCRIPTION_MUTATION_FAILED",
  "FEISHU_SUBSCRIPTION_READ_FAILED",
  "FEISHU_SUBSCRIPTION_UNAVAILABLE",
  "FEISHU_SUBSCRIPTION_VERIFY_FAILED",
  ...
  "WRITEBACK_INTENT_INVALID",
  "WRITEBACK_UNAVAILABLE",
  "WRITEBACK_CLAIM_STALE",
  "WRITEBACK_INVALID",
  "WRITEBACK_REFERENCE_INVALID",
  "WRITEBACK_RESOLUTION_INVALID",
].map((code) => [code, code]));
...
export function classifyDeliveryError(error) {
  ...
  return {
    ...
    retryable: code === "TASKBOARD_UNAVAILABLE"
      || code === "TASKBOARD_PROVENANCE_ROUTE_UNAVAILABLE"
